...
<table class="selector">
    ...
    <tr class="even">
        <td class="tasklist nowrap" style="width: 10%;">{docURL page="user/en/4.7/contributions/what-is-civicontribute" text="CiviContribute"}</td>
        <td>{ts}Online fundraising and donor management, as well as offline contribution processing and tracking.{/ts}</td>
    </tr>
    <tr class="even">
        <td class="tasklist nowrap" style="width: 10%;">{docURL page="user/en/4.7/pledges/what-is-civipledge" text="CiviPledge"}</td>
        <td>{ts}Accept and track pledges (for recurring gifts).{/ts}</td>
    </tr>
    <tr class="even">
        <td class="tasklist nowrap">{docURL page="user/en/4.7/events/what-is-civievent" text="CiviEvent"}</td>
        <td>{ts}Online event registration and participant tracking.{/ts}</td>
    </tr>
    <tr class="even">
        <td class="tasklist nowrap">{docURL page="user/en/4.7/membership/what-is-civimember" text="CiviMember"}</td>
        <td>{ts}Online signup and membership management.{/ts}</td>
    </tr>
    <tr class="even">
        <td class="tasklist nowrap">{docURL page="user/en/4.7/email/what-is-civimail" text="CiviMail"}</td>
        <td>{ts}Personalized email blasts and newsletters.{/ts}</td>
    </tr>
    <tr class="even">
        <td class="tasklist nowrap">{docURL page="user/en/stable/campaign/what-is-civicampaign" text="CiviCampaign"}</td>
        <td>{ts}Link together events, mailings, activities, and contributions. Create surveys and online petitions.{/ts}</td>
    </tr>
    <tr class="even">
        <td class="tasklist nowrap">{docURL page="user/en/4.7/case-management/what-is-civicase" text="CiviCase"}</td>
        <td>{ts}Integrated case management for human service providers{/ts}</td>
    </tr>
    <tr class="even">
        <td class="tasklist nowrap">{docURL page="user/en/4.7/grants/what-is-civigrant" text="CiviGrant"}</td>
